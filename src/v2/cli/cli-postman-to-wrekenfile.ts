...
function printUsage() {
  console.log('Usage: npx ts-node src/v2/cli/cli-postman-to-wrekenfile.ts --input <postman_collection.json> [--output <wrekenfile.yaml>] [--env <postman_environment.json>]');
  process.exit(1);
}
